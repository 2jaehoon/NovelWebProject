...
<header class="relative bg-white border-b-1 border-grey20">
	<div
		...
		<a
			...
			href="/novelWebProject/home/main.jsp"> <img
			class="object-contain" width="157" height="27"
			src="/novelWebProject/_next/static/images/logo.png" alt="소설조아 logo" />
		</a>
		<div
		...
		<div class="flex items-center ml-auto mr-15 desktop:mr-0">
			<a class="mr-16 flex items-center text-grey70"
				href="/novelWebProject/novel/search_before.jsp?search="><img
				src="/novelWebProject/_next/static/images/search.png" width="24"
				height="24"></a> &nbsp; &nbsp; &nbsp; <a
				class="mr-16 flex items-center text-grey70"
				href="/novelWebProject/login/my_page.jsp"><img
				src="/novelWebProject/_next/static/images/profile_images/<%=session.getAttribute("user_photo") %>" width="48"
				height="48"></a>
		</div>
	</div>
</header>