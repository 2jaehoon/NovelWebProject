...
<header class="relative bg-white border-b-1 border-grey20">
	<div class="flex mx-auto w-full max-w-default flex-row flex-wrap desktop:px-22 flex-wrap items-center desktop:min-h-[72px] desktop:flex-nowrap desktop:py-12">
		<a class="ml-15 mr-16 max-w-[145px] flex-shrink flex-grow basis-0 py-[13.5px] desktop:ml-0 desktop:mr-32 desktop:max-w-[174px] desktop:py-0" href="/novelWebProject/home/main(logout).jsp">
		...
		<div class="flex items-center ml-auto mr-15 desktop:mr-0">
			...
			desktop:text-white" onclick="location.href='/novelWebProject/manager/manager_login.jsp'">로그인</button>
		</div>
	</div>
</header>
