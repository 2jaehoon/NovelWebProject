...
<div style="margin-top: 20px;">
	<button id="btn" onclick="location.href='/novelWebProject/manager/manager_user.jsp'">회원관리</button>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button id="btn" onclick="location.href='/novelWebProject/manager/manager_novel.jsp'">소설관리</button>
</div>
</main>
